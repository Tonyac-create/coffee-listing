...
function App() {
  ...
  return (
    <main className="relative h-screen overflow-auto bg-blackBG font-DMS">
      ...
      <section className="absolute top-32 left-1/4 right-1/4 flex flex-col items-center min-w-[240px] max-w-[440px] bg-lightBlack rounded-2xl py-14 px-6 sm:min-w-[440px] sm:max-w-[890px] xl:min-w-[900px] xl:max-w-[1100px]">
